...
<MobileElementEntity>
   ...
   <name>android.widget.EditText - exampleexample.com (2)</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = 'example@example.com' or . = 'example@example.com') and @resource-id = '']</locator>
