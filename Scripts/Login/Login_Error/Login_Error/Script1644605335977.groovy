...
Mobile.tap(findTestObject('Login_Error/android.widget.Button'), 0)

Mobile.tap(findTestObject('Login_Error/android.widget.EditText'), 0)

Mobile.setText(findTestObject('Login_Error/android.widget.EditText (1)'), 'Test@test12.com', 0)

Mobile.tap(findTestObject('Login_Error/android.widget.EditText (2)'), 0)

Mobile.setText(findTestObject('Login_Error/android.widget.EditText (3)'), 'Caferio123++', 0)

Mobile.tap(findTestObject('Login_Error/android.widget.Button (1)'), 0)

Mobile.verifyElementVisible(findTestObject('Object Repository/Login_Error/android.widget.ImageView'), 10)
