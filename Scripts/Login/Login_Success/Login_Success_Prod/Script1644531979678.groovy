...
Mobile.startExistingApplication(GlobalVariable.cafeRio_Prod)
...
Mobile.setText(findTestObject('Object Repository/Login/android.widget.EditText (1)'), GlobalVariable.UserEmail_Prod, 0)

Mobile.tap(findTestObject('Object Repository/Login/android.widget.EditText (2)'), 0)

Mobile.setText(findTestObject('Object Repository/Login/android.widget.EditText (3)'), GlobalVariable.Password_Prod, 0)
