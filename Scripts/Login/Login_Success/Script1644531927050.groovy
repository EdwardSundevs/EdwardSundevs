...
Mobile.setText(findTestObject('Object Repository/Login/android.widget.EditText (1)'), 'Lorenreshen@gmail.com', 0)

Mobile.tap(findTestObject('Object Repository/Login/android.widget.EditText (2)'), 0)

Mobile.setText(findTestObject('Object Repository/Login/android.widget.EditText (3)'), 'Sundevs_2021', 0)
